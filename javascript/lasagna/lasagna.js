...
// cuanto le falta a la comida para estar lista 
export const EXPECTED_MINUTES_IN_OVEN = 40
export function remainingMinutesInOven(actualMinutesInOven) {
  let resta_time =  EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven
  console.log(resta_time) //check: Todo bien
  return(resta_time)
}
...
export function preparationTimeInMinutes(numberOfLayers) {
  let suma_tiempo = numberOfLayers * PREPARATION_MINUTES_PER_LAYER
  console.log(suma_tiempo) //check: todo bien
  return(suma_tiempo)
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
 let tiempo_total = (numberOfLayers*PREPARATION_MINUTES_PER_LAYER) + actualMinutesInOven
 console.log(tiempo_total) //check: TODO BIEN 
 return(tiempo_total)
}
